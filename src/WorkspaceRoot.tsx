...
function demo(week:string,role:string,requests:ScheduleRequest[]=[]):SchedulerData{
 const people:Person[]=[{id:'s:Alex.L',staff_id:'Alex.L',name:'Alex Lane',group:'FOH',active:true,on_roster:true,is_trainer:true,is_ca:true,primary_job_id:'gsr'},{id:'s:Casey.W',staff_id:'Casey.W',name:'Casey Williams',group:'FOH',active:true,on_roster:true,is_trainer:false,primary_job_id:'gsr'},{id:'s:Jordan.D',staff_id:'Jordan.D',name:'Jordan Davis',group:'BOH',active:true,on_roster:true,is_trainer:false},{id:'m:demo',name:'Morgan Hayes',group:'SHL',active:true,on_roster:true,is_trainer:false,employment_type:'Hourly',manager_version:1},{id:'m:salary-demo',name:'Taylor Brooks',group:'SHL',active:true,on_roster:true,is_trainer:false,employment_type:'Salaried',manager_version:1}];
