...
export function WorkspaceRoot({legacy}:{legacy:(back:(view?:string,staff?:string,job?:string)=>void,authors:Record<string,string>)=>ReactNode}){
 ...
 <div className={'content'+(view==='schedule'?' schedule-content':'')} key={workspace}><p className="notice pilot-notice">Shift pilot · Schedulefly remains the official schedule until your manager announces the cutover.</p>
