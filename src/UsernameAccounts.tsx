...
export function UsernameAccounts({data,preview,reload,staffFilter}:{staffFilter?:string;data:SchedulerData;preview:boolean;reload:()=>Promise<void>}){
 ...
 const [staff,setStaff]=useState(staffFilter||''),[username,setUsername]=useState(''),[role,setRole]=useState('employee'),[editing,setEditing]=useState<Account|null>(null),[editName,setEditName]=useState('');
