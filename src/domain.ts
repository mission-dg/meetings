...
export type Employee={id:string;first_name:string;last_name:string;department:'FOH'|'BOH'|'Catering'|'SHL';active:boolean;priority:boolean;is_trainer?:boolean;trainer_job_ids?:string[];version?:number;primary_job_id?:string|null};
